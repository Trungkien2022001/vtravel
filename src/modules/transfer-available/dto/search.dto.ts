...
export class TransferSearchDto extends BaseTransferSeachRequestDto {
  @IsString()
  @Length(3)
  @ApiProperty({
    type: String,
...
export class TransferSearchResponseDto extends BaseAPIResponseDTO<TransferSearchResponse> {}
