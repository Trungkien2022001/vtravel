...
@Controller('v1/hotel/retrieve')
@ApiTags('Hotel Retrieve Component')
export class HotelRetrieveController {
  constructor(private readonly HotelRetrieveService: HotelRetrieveService) {}
  ...
  async SearchByAirportCode(@Body() body: any) {
    return this.HotelRetrieveService.get();
  }
}
